...
def confusion(con_str, num_class, tl, pl, save=False):
    ...
    if save:
        ...
        plt.savefig('/content/drive/My Drive/Project_SS24/MedAugment/recording/classification/' + str(con_str) + 'matrix.pdf', bbox_inches='tight', pad_inches=0.0, dpi=300)
        plt.show()
...
def calculate_metrics_cls(conf_mat, con_str, e=1e-6):
    ...
    with open('/content/drive/My Drive/Project_SS24/MedAugment/recording/classification/' + str(con_str) + 'metrics.json', "w") as f:
