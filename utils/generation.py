...
def generate_datasets(train_type, dataset, seed):
    ...
    if train_type == "classification":
        ...
        data_path = f"/content/drive/My Drive/Project_SS24/MedAugment/dataset/classification/{dataset}/baseline/training/"
        folder_path = f"/content/drive/My Drive/Project_SS24/MedAugment/dataset/classification/{dataset}/"
        ...
        data_path = f"/content/drive/My Drive/Project_SS24/MedAugment/dataset/segmentation/{dataset}/baseline/"
        folder_path = f"/content/drive/My Drive/Project_SS24/MedAugment/dataset/segmentation/{dataset}/"
...
def main():
    ...
    group.add_argument('--dataset', help='Select dataset', choices=['btmri', 'busi', 'cataract', 'lung', 'covid', 'kvasir', 'cvc'], default='cataract')
