...
def cls_data_aug(dataset, index, bs, device):
    ...
    train_d = ImageFolder(f"/content/drive/My Drive/Project_SS24/MedAugment/dataset/classification/{dataset}/{set_type}/training", transform=transform)
    val_d = ImageFolder(f"/content/drive/My Drive/Project_SS24/MedAugment/dataset/classification/{dataset}/{set_type}/validation", transform=transform)
    test_d = ImageFolder(f"/content/drive/My Drive/Project_SS24/MedAugment/dataset/classification/{dataset}/{set_type}/test", transform=transform)
